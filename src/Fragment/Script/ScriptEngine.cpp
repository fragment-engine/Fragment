...
bool Fragment::Script::ScriptEngine::run_shell = false;
 ...
 */
class Fragment::Script::ScriptEngine::ShellArrayBufferAllocator : public v8::ArrayBuffer::Allocator {
public:
...
Fragment::Script::ScriptEngine::ScriptEngine() {
...
// functions.
v8::Local<v8::Context> Fragment::Script::ScriptEngine::CreateShellContext(v8::Isolate *isolate) {
...
void Fragment::Script::ScriptEngine::Read(const v8::FunctionCallbackInfo<v8::Value> &args) {
    if (args.Length() != 1) {
...
void Fragment::Script::ScriptEngine::Quit(const v8::FunctionCallbackInfo<v8::Value> &args) {
...
void Fragment::Script::ScriptEngine::Version(const v8::FunctionCallbackInfo<v8::Value> &args) {
...
v8::MaybeLocal<v8::String> Fragment::Script::ScriptEngine::ReadFile(v8::Isolate *isolate, const char *name) {
...
int Fragment::Script::ScriptEngine::RunMain(v8::Isolate *isolate, v8::Platform *platform, int argc,
            char *argv[]) {
